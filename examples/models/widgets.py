...
multi_select = MultiSelect(options=[f"Option {i + 1}" for i in range(16)], size=6)

multi_choice = MultiChoice(options=[f"Option {i + 1}" for i in range(16)], placeholder="Choose your option ...")
